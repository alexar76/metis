...
ECOSYSTEM_MCP_CATALOG = {
    ...
    "aimarket-web": {
        "repo": "https://github.com/alexar76/aimarket-mcp",
        "description": "Ecosystem MCP gateway — web fetch/search + Metis verify (SSRF-hardened)",
        "glama": "https://glama.ai/mcp/servers/alexar76/aimarket-mcp",
        "tools_count": 3,
    },
}
