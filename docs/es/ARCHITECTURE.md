...
3. [Flujo de datos de consulta a respuesta](#flujo-de-datos-de-consulta-a-respuesta)
4. [Componentes principales](#componentes-principales)
   - [Exoesqueleto Metis](#exoesqueleto-metis)
   - [Enrutador](#enrutador)
   - [Understanding Council](#understanding-council)
   - [Confidence Gate](#confidence-gate)
   - [DGPD — profundidad del pipeline L0–L3](#dgpd--profundidad-del-pipeline-l0l3)
   - [Mixture-of-Agents en capas](#mixture-of-agents-en-capas)
   - [Verificador](#verificador)
   - [Bucle de agente](#bucle-de-agente)
   - [Memoria y RAG](#memoria-y-rag)
   - [Pipeline de búsqueda](#pipeline-de-búsqueda)
   - [Registro de herramientas](#registro-de-herramientas)
   - [Integración MCP](#integración-mcp)
5. [Clúster distribuido](#clúster-distribuido)
6. [Economía y facturación](#economía-y-facturación)
7. [Capas de seguridad](#capas-de-seguridad)
8. [API compatible con OpenAI](#api-compatible-con-openai)
9. [Integración con IDE](#integración-con-ide)
10. [Registro de módulos y proveedores](#registro-de-módulos-y-proveedores)
11. [Integración del ecosistema](#integración-del-ecosistema)
12. [Referencia de configuración](#referencia-de-configuración)
13. [Tablas de componentes](#tablas-de-componentes)
