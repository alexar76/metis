...
3. [Поток данных от запроса к ответу](#поток-данных-от-запроса-к-ответу)
4. [Основные компоненты](#основные-компоненты)
   - [Экзоскелет Metis](#экзоскелет-metis)
   - [Маршрутизатор](#маршрутизатор)
   - [Understanding Council](#understanding-council)
   - [Confidence Gate](#confidence-gate)
   - [DGPD — глубина пайплайна L0–L3](#dgpd--глубина-пайплайна-l0l3)
   - [Многослойный Mixture-of-Agents](#многослойный-mixture-of-agents)
   - [Верификатор](#верификатор)
   - [Цикл агента](#цикл-агента)
   - [Память и RAG](#память-и-rag)
   - [Пайплайн поиска](#пайплайн-поиска)
   - [Реестр инструментов](#реестр-инструментов)
   - [Интеграция MCP](#интеграция-mcp)
5. [Распределённый кластер](#распределённый-кластер)
6. [Экономика и биллинг](#экономика-и-биллинг)
7. [Слои безопасности](#слои-безопасности)
8. [OpenAI-совместимый API](#openai-совместимый-api)
9. [Интеграция с IDE](#интеграция-с-ide)
10. [Реестр модулей и провайдеры](#реестр-модулей-и-провайдеры)
11. [Интеграция с экосистемой](#интеграция-с-экосистемой)
12. [Справочник конфигурации](#справочник-конфигурации)
13. [Таблицы компонентов](#таблицы-компонентов)
14. [Связанная документация](#связанная-документация)
...
|------------|------|-------------------|
| cognitive-runtime | Prior exoskeleton reference implementation | Shared DGPD, council, and MoA concepts; Metis is the production successor |
